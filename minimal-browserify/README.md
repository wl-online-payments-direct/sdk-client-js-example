# browserify Direct Client SDK Example

## What is it?

This example shows you how to load the [Ingenico Direct JavaScript Client SDK](https://github.com/Ingenico/direct-sdk-client-js) with the browserify module loader.
